...
# --- CONEXIÓN SEGURA CON GOOGLE SHEETS (MÉTODO OFICIAL Y DEFINITIVO) ---
@st.cache_resource
def conectar_google_sheets():
    try:
        scopes = ["https://spreadsheets.google.com/feeds", 'https://www.googleapis.com/auth/spreadsheets', "https://www.googleapis.com/auth/drive.file", "https://www.googleapis.com/auth/drive"]
        
        # Lee las credenciales directamente desde el formato TOML de Streamlit Secrets
        ...
        st.info("Asegúrate de haber configurado los secretos en Streamlit Cloud con el formato correcto y de haber reiniciado la app.")
        return None
