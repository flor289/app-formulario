...
SECCIONES_PDI = {
    ...
    "2. Formación y Nivel Educativo": {
        ...
        "¿Está relacionado con su formación académica?": {'col': "¿está relacionado con su formación académica?", 'type': 'checkbox', 'options': ["Totalmente", "Parcialmente", "No", "Sí, totalmete"]}
    },
